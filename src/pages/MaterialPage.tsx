...
const materialGridColumns = [
  ...
  { field: "name", headerText: "Material" },
  { field: "category", headerText: "Category" },
  { field: "unit", headerText: "Unit", width: 80 },
  { field: "unitPrice", headerText: "Unit Price ($)" },
  { field: "quantity", headerText: "Stock" },
  { headerText: "Stock Status", template: stockStatusTemplate },
  ...
  return (
    ...
    >
      <BaseCrudPage
        ...
        summaryCards={<MaterialSummaryCards materials={initialMaterials} />}
      />
    </MainLayout>
  );
};
